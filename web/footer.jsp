<%-- 
    Document   : footer
    Created on : Dec 5, 2022, 10:44:59 AM
    Author     : Admin
--%>
...
<!-- Footer Start -->
        ...
        <script src="<%=request.getContextPath()%>/assets/mail/jqBootstrapValidation.min.js"></script>
        <script src="<%=request.getContextPath()%>/assets/mail/contact.js"></script>
